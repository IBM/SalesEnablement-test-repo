...
18. Click the route link ![](_attachments/openShiftWC-RouteLinkIcon.pnf) icon to open the web page front end to the deployed application.
...
![](_attachments/openShiftWC-NewDeploymentAnimation.png)

27. Click the route link ![](_attachments/openShiftWC-RouteLinkIcon.pnf) icon to open the web page front end to the deployed application in the **{{ ibm.cluster_name }} cluster.
...
36. Click the **Resolve conflicts** button.

![](_attachments/github-ResolveConflictsButton.png)
