...
1.  Click the **Pull requests** link at the top of the GitHub page.
...
1. Before proceeding, copy and record the URL for your repository. This URL will be needed later. The URL will be in the format: https://github.com/**<your git user ID>**/satellite-config-example. The user ID and last part of the URL appears in GitHub as illustrated below:
